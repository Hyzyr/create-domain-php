              ...
              <div class="nav__inner">
                ...
                <div class="nav__item _dropdown">
                  ...
                  <div class="nav__item-dropdown">
                    <a class="nav__item" href="#why-you-should-invest">
                      Why you should Invest
                    </a>
                    <a class="nav__item" href="#competitor-comparison">
                      Competitor Comparison
                    </a>
                    <a class="nav__item" href="#roadmap">RoadMap</a>
                  </div>
                </div>
                <div class="nav__item _dropdown">
                  Docs
            ...
            <div class="hero__inner-group">
              ...
              <div class="hero__inner-coins">
                ...
                <span class="_bitcoin animate zoomIn" data-wow-delay="0.3s"
                  >.bitcoin</span
                >
                <span class="_blockchain animate zoomIn" data-wow-delay="0.4s"
                  >.blockchain</span
                >
                <span class="_crypto animate zoomIn" data-wow-delay="0.5s"
                  >.crypto</span
                >
                <span class="_wallet animate zoomIn" data-wow-delay="0.6s"
                  >.wallet</span
                >
                <span class="_nft animate zoomIn" data-wow-delay="0.7s"
                  >.nft </span
                >
                <span class="_polygon animate zoomIn" data-wow-delay="0.8s"
                  >.polygon</span
                >
              </div>
            </div>
          ...
          <div class="hero__footer">
            <div class="hero__footer-buy">
              <div>
                ...
                <div class="hero__footer-buy-label copyBox">
                  <span>Contract</span>
            ...
            <div class="hero__footer-apps">
              ...
              <div class="hero__footer-apps-links">
                ...
                <div class="hero__footer-apps-tab _apple">
                  App Submitted for approval to Apple App Store. Users can Beta
                  test the App by downloading it
                  <a
                    class="textLink"
            ...
            <div class="videoSection__inner-frame animate fadeInUp">
              <div class="videoContainer" id="playVideo">
                ...
                <iframe
                  width="420"
                  height="345"
                  src="https://www.youtube.com/embed/0Re4aoOOYEw"
                >
                </iframe>
              </div>
            </div>
        ...
        <div class="autoContainer">
          <div class="partners__inner">
            ...
            <div class="partners__inner-row">
              <a href="https://metamask.io/" class="partners__inner-item">
                <img
              ...
              <a href="https://arbiscan.io/" class="partners__inner-item">
                <img
                  class="animate rotateIn"
              ...
              <a href="https://coinmarketcap.com/" class="partners__inner-item">
                <img
                  class="animate rotateIn"
              ...
              <a href="https://www.coingecko.com/" class="partners__inner-item">
                <img
                  class="animate rotateIn"
              ...
              <a href="https://uniswap.org/" class="partners__inner-item">
                <img
                  class="animate rotateIn"
                  data-wow-delay="1s"
                  data-wow-duration="1.1s"
              ...
              <a href="https://auditace.tech/" class="partners__inner-item">
                <img
                  class="animate rotateIn"
                  data-wow-delay="1.1s"
                  data-wow-duration="1.2s"
              ...
              <a href="https://dexscreener.com/" class="partners__inner-item">
                <img
                  class="animate rotateIn"
                  data-wow-delay="1.2s"
                  data-wow-duration="1.3s"
